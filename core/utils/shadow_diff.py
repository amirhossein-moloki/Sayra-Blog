...
def compare_responses(
    django_data: Any, playnest_data: Any, ignore_keys: List[str] = None
    ...
    if type(django_data) is not type(playnest_data):
        return (
            "MISMATCH",
            "CRITICAL",
            {
                "error": "Type mismatch",
                "django_type": str(type(django_data)),
                "playnest_type": str(type(playnest_data)),
            },
        )
